        ...
        <!-- row opened--> */}
                    ...
                    <select name="somename" class="form-control SlectBox main-select"
                        ...
                        <div class="col-lg-4">
                            ...
                            <input className='form-control form-control-sm mt-1' placeholder='Enter Buyer Code'
                                value={fields.buyCode} minLength="1" maxLength="10"
                                onChange={inputOnChange("buyCode")} disabled={buyerCodeVisible}
                            />
                        </div>
                        {/* <div className='mt-3'>
                <div className='d-flex flex-wrap align-items-center justify-content-between'>
                ...
                <div class="">
                    ...
                    <button class="btn btn-primary search-btn btn-block ml-10">Cancel</button>
                            ...
                            {/* <button className='btn btn-primary search-btn btn-block ml-10' onClick={(e) => {
                                    let _id = fields.buyCode
                                    if (_id === "") add()
                                    else edit(_id)
                                }}> Clear </button> */}
                            <div class="">
                                {/* <button class="btn btn-success search-btn btn-block ml-10" disabled={loader} onClick={save}>Save</button> */}
                                {Savevisible && <button class="btn btn-success search-btn btn-block ml-10" disabled={loader} onClick={() => Save(fields.buyCode.toUpperCase(), 'save')}>Save</button>}
                                {updatevisible && <button class="btn btn-success search-btn btn-block ml-10" disabled={loader} onClick={() => Save(fields.buyCode.toUpperCase(), 'update')}>Update</button>}
                            </div>
                            {/* <button disabled={loader} className='btn-sm btn defect-master-save mt-1 w-100' onClick={save}> {fields.id === 0 ? "Save" : "Update"} </button>   */}
