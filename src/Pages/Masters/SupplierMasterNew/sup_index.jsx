                    ...
                    <div class="row mt-15 dis-sel mt-20">
                        <div class="col-lg-4">
                            ...
                            <div class="main-select">
                                <select name="somename" class="form-control SlectBox main-select" placeholder='Select Supplier Category'
                                    required
                                ...
                                <div class="row mt-15">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <Radio.Group onChange={inputOnChange("tdsType")} value={fields.tdsType}>
                                            ...
                                            <Radio value="Otherthan Company">Otherthan Company</Radio>
                                        </Radio.Group>
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <Radio.Group onChange={inputOnChange("tdsCategory")} value={fields.tdsCategory}>
                                            <Radio value="Firms">Firms Firms</Radio>
