...
function SizeMaster({ name }) {
    ...
    const getDatas = () => {
        setListLoading(true)
        ApiCall({
            path: API_URLS.GET_SIZE_MASTER_LIST
        }).then(resp => {
    ...
    return (
        <div className='defect-master-main'>
            ...
            } title={< h6 className='m-0' > {`${fields.id === 0 ? "Add New" : "Edit"} Size`}</h6 >} placement="right" onClose={() => {
                clearFields();
                onClose();
            }} visible={visible} >
