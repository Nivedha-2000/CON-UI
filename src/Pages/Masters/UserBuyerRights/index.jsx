    ...
    getBuyerusersave() {
        if ((this.state.userlevel == "singleuser" && this.state.username.length > 0) || (this.state.userlevel == "copyuser" && this.state.touser.length > 0)) {
            ...
            for (const item of this.state.buyerrightlists) {
                if (item.notify == "Y") {
                    dataset.push({
                        createdDate: "2022-07-26T07:40:13.577Z",
                        createdBy: "ADMIN",
                        modifiedDate: "2022-07-26T07:40:13.577Z",
                        modifiedBy: "ADMIN",
                        isActive: true,
                        userId: user_id,
                        buyerCode: item.buyCode,
                        buyerDivCode: item.buyDivCode,
                        notify: "Y",
                        hostName: "ADMIN"
                    });
                    validation = 'true';
                ...
                <div className="category-container rct-block">
                    <Accordion expanded>
                        <AccordionSummary expandIcon={<i className="zmdi zmdi-chevron-down"></i>}>
                            ...
                            <button type="button" className='col-sm-1 col-md-1 float-left col-xl-1 p-0 defect-master-add' onClick={(e) => this.getBuyerusersave()}>save</button>
