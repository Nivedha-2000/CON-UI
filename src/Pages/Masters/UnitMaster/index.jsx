...
function UnitMaster({ name }) {
    ...
    return (
        <div className='defect-master-main'>
            ...
            <Drawer footer={
            ...
            } title={< h6 className='m-0' > {`${fields.id === 0 ? "Add New" : "Edit"} Unit`}</h6 >} placement="right" onClose={() => {
                clearFields();
                onClose();
            }} visible={visible} >
                <div className='defect-master-add-new'>
                    ...
                    <div className='mt-3'>
                        ...
                        <input className='form-control form-control-sm mt-1' placeholder='Enter Unit Code Value'
                    ...
                    <div className='mt-3'>
                        ...
                        <input className='form-control form-control-sm mt-1' placeholder='Enter Unit Name Value'
                    ...
                    <div className='mt-3'>
                        ...
                        <input className='form-control form-control-sm mt-1' placeholder='Enter loccode'
