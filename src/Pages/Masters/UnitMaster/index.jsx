...
const requiredFields = ["uCode", "uName", "address1", "address2", "address3", "city", "pinCode", "loccode", "country", "tngstNo", "tinNo", "tanNo", "cinNo", "cstNo", "panNo", "stNo", "areaCode", "emailId", "contPerson1", "contPerson2", "contNo", "gstNo"],
    ...
    const Save = async (uCode, type) => {
        ...
        if (validation) {
            if (type === "update") {
                ...
                ItrApiService.GET({
                    url: API_URLS.GET_UNIT_MASTER_BY_ID + "/" + uCode,
                    appCode: "CNF"
                }).then(res => {
                    //  alert(res.Success);
    ...
    return (
        ...
        <!-- row opened--> */}
                    ...
                    <div class="row mt-15 dis-sel mt-20">
                        <div class="col-lg-6">
                            ...
                            <input className='form-control form-control-sm mt-1' placeholder='Enter Unit Code'
                                ...
                                onChange={inputOnChange("uCode")} disabled={entityVisible}
                            />
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input className='form-control form-control-sm mt-1' placeholder='Enter Unit Name'
                                value={fields.uName} minLength="1" maxLength="100"
                                onChange={inputOnChange("uName")} disabled={entityVisible}
                            />
                        </div>
                    ...
                    <button class="btn btn-primary search-btn btn-block ml-10">Cancel</button>
                            ...
                            <div class="">
                                {Savevisible && <button class="btn btn-success search-btn btn-block ml-10" disabled={loader} onClick={() => Save(fields.uCode, 'save')}>Save</button>}
                                {updatevisible && <button class="btn btn-success search-btn btn-block ml-10" disabled={loader} onClick={() => Save(fields.uCode, 'update')}>Update</button>}
